...
class LMTR_params_options:
    def __init__(self,eta1=0.1,eta2=0.75,gamma1=0.85,gamma2=0.5,gamma3=1.5,lambda0=0.05,lambda_min=1e-4,epsilon = 1e-4,max_iter=1000):
        ...
        self.lambda0 = 0.05 #initial value of the regularization coefficient
