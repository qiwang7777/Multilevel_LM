...
# Copyright (C) Long Chen. See COPYRIGHT.txt for details.
  ...
  if order == 1:     # Order 1, nQuad 1
    ...
    weight = [-27/48, 25/48, 25/48, 25/48]
          ...
          lam = np.array([[0.108103018168070, 0.445948490915965, 0.445948490915965],
                    [0.445948490915965, 0.108103018168070, 0.445948490915965],
                    [0.445948490915965, 0.445948490915965, 0.108103018168070],
                    [0.816847572980459, 0.091576213509771, 0.091576213509771],
                    [0.091576213509771, 0.816847572980459, 0.091576213509771],
                    [0.091576213509771, 0.091576213509771, 0.816847572980459]])
          weight = [0.223381589678011, 0.223381589678011, 0.223381589678011, 0.109951743655322, 0.109951743655322, 0.109951743655322]
  elif order ==  5:     # Order 5, nQuad 7
          alpha1 = 0.059715871789770
          beta1  = 0.470142064105115
          alpha2 = 0.797426985353087
          beta2  = 0.101286507323456
          lam = np.array([[   1/3,    1/3,    1/3],
                   [alpha1,  beta1,  beta1],
                    [beta1, alpha1,  beta1],
                    [beta1,  beta1, alpha1],
                    ...
                    [beta2, alpha2,  beta2],
                    [beta2,  beta2, alpha2]])
          weight = [0.225, 0.132394152788506, 0.132394152788506, 0.132394152788506, 0.125939180544827, 0.125939180544827, 0.125939180544827]
  elif order ==  6:
          ...
          lam = np.vstack((A[:,0], A[:,1], 1 - np.sum(A[:,[0,1]],axis=1))).T
          weight = A[:,2]
  elif order ==  7:
...
def sparse(i, j, v, m, n):
    ...
    """
    return sp.sparse.csr_matrix((v, (i, j)), shape=(m, n))
